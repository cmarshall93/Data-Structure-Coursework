...
import marshac3.dictionary.structure.WordMap;
...
public class ChineseDictionary extends AbstractDictionary {
	...
	public void addPinyin(String key, DictionaryEntry entry){
		...
		//remove the square brackets from the pinyin before adding
...
/**
	...
	private String searchByPrefix(String prefix){
		String result = "";
		//go through every traditional chinese string and check if it starts with the given prefix.
